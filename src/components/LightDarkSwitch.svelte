...
const _props = $props<{ [key: string]: unknown }>();
...
<div class="relative z-50" role="menu" tabindex="-1" onmouseleave={hidePanel}>
    ...
    <div id="light-dark-panel" class="hidden lg:block absolute transition float-panel-closed top-11 -right-2 pt-5" >
        <div class="card-base float-panel p-2">
            ...
            >
                <Icon icon="material-symbols:wb-sunny-outline-rounded" class="text-[1.25rem] mr-3" aria-hidden="true"></Icon>
            ...
            >
                <Icon icon="material-symbols:dark-mode-outline-rounded" class="text-[1.25rem] mr-3" aria-hidden="true"></Icon>
            ...
            >
                <Icon icon="material-symbols:radio-button-partial-outline" class="text-[1.25rem] mr-3" aria-hidden="true"></Icon>
